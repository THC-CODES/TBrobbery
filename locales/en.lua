Locales['en'] = {
    ...
    ['recently_robbed'] = 'this store was recently been robbed. Please wait ~b~%s~s~ seconds until you can rob again',
    ...
    ['robbery_finished'] = '~r~The robbery has been successful~s~, you ~b~stole~s~ ~g~$%s~s~',
